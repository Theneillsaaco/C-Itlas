...
namespace School.DAL.Dao
{
    public class DaoOnlineCourse : IDaoOnlineCourse
    {
        ...
        public void RemoveOnlineCourse(OnlineCourse onlineCourse)
        {
            ...
            onlineCourseToRemove.Deleted = onlineCourse.Deleted;
            onlineCourseToRemove.DeletedDate = onlineCourse.DeletedDate;
            onlineCourseToRemove.UserDeleted = onlineCourse.UserDeleted;
        ...
        public void UpdateOnlineCourse(OnlineCourse onlineCourse)
        {
            ...
            onlineCourseToUpdate.ModifyDate = onlineCourse.ModifyDate;
            onlineCourseToUpdate.UserMod = onlineCourse.UserMod;
