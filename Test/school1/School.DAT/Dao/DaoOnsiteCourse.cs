...
namespace School.DAL.Dao
{
    public class DaoOnsiteCourse : IDaoOnsiteCourse
    {
        ...
        public void RemoveOnsiteCourse(OnsiteCourse onsiteCourse)
        {
            ...
            onsiteCourseToRemove.Deleted = onsiteCourse.Deleted;
            onsiteCourseToRemove.DeletedDate = onsiteCourse.DeletedDate;
            onsiteCourseToRemove.UserDeleted = onsiteCourse.UserDeleted;
        ...
        public void UpdateOnsiteCourse(OnsiteCourse onsiteCourse)
        {
            ...
            onsiteCourseToUpdate.ModifyDate = onsiteCourse.ModifyDate;
            onsiteCourseToUpdate.UserMod = onsiteCourse.UserMod;
